...
my_pathlist=["/home/ali/Documents/projects/COVID_projects/COVID_data/Moderate/M1/KUTTAM_20201003_ATS-M1-1.xlsx",
             "/home/ali/Documents/projects/COVID_projects/COVID_data/Moderate/M1/KUTTAM_20201022_ATS_M1-2.xlsx",
             "/home/ali/Documents/projects/COVID_projects/COVID_data/Moderate/M1/KUTTAM_20201010_ATS_M1-3.xlsx",
             "/home/ali/Documents/projects/COVID_projects/COVID_data/Moderate/KUTTAM_20201106_ATS_M2-1.xlsx",
             "/home/ali/Documents/projects/COVID_projects/COVID_data/Moderate/KUTTAM_20201110_ATS_M3-1.xlsx",
             "/home/ali/Documents/projects/COVID_projects/COVID_data/Moderate/M4/KUTTAM_20201208_ATS_S3-1.xlsx",
             "/home/ali/Documents/projects/COVID_projects/COVID_data/Moderate/M4/KUTTAM_20201209_ATS_S3-2.xlsx"]
...
# control17=pd.read_excel(my_pathlist[16])
# control18=pd.read_excel(my_pathlist[17])
...
# control17["genes"]=pd.Series(all_genes[16])
# control18["genes"]=pd.Series(all_genes[17])
...
# #
new_frame= z[z.columns[[3,9,26,111,17,34,119]]]
print(new_frame)

new_frame.columns=["Accession","M1_1","M1_3","M3_1","M1_2","M2_1","M4_1","M4_2","genes1_1","genes1_3","genes3_1","genes1_2","genes2_1","genes4_1","genes4_2"]
...
# # # #
# # #HEALTHY SUBJECTS
# # new_frame.columns=["Accession","H1","H2","H3","H4","H5","H6","H7","H8","H9","H10","genes1","genes3","genes5","genes7","genes9",
# #                    "genes2","genes4","genes6","genes8","genes10"]
# #
...
# # # #
# # # #
new_frame=new_frame[["Accession","genes1_1","M1_1","M1_2","M1_3","M2_1","M3_1","M4_1","M4_2"]]
#
# new_frame=new_frame[["Accession","genes1","H1","H2","H3","H4","H5","H6","H7","H8","H9","H10"]]
...
new_frame.to_excel("/home/ali/Desktop/combined_filtered_moderate.xlsx")
