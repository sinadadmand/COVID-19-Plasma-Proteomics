...
my_pathlist=["/home/ali/Documents/projects/COVID_projects/COVID_data/Criticals/C1/KUTTAM_20201013_ATS_C1-1.xlsx",
             ...
             # "/home/ali/Documents/projects/COVID_projects/COVID_data/Criticals/C1/KUTTAM_20201007_ATS_C1-3.xlsx",
...
# my_pathlist=["/home/a/Desktop/covid_project_June10/PDExcels/Healthy/KUTTAM_20201002_ATS_H1.xlsx",
#              "/home/a/Desktop/covid_project_June10/PDExcels/Healthy/KUTTAM_20201010_ATS_H2.xlsx",
#              "/home/a/Desktop/covid_project_June10/PDExcels/Healthy/KUTTAM_20210522_ATS_H3.xlsx",
#              "/home/a/Desktop/covid_project_June10/PDExcels/Healthy/KUTTAM_20210524_ATS_H4.xlsx",
#              "/home/a/Desktop/covid_project_June10/PDExcels/Healthy/KUTTAM_20210526_ATS_H5.xlsx",
#              "/home/a/Desktop/covid_project_June10/PDExcels/Healthy/KUTTAM_20210514_ATS_H6.xlsx",
...
#              "/home/a/Desktop/covid_project_June10/PDExcels/Healthy/KUTTAM_20210511_ATS_H10.xlsx"]
#
...
# list_control1=control1[(control1["genes"]=="C3")|(control1["genes"]=="ALB")|(control1["genes"]=="APOB")|(control1["genes"]=="A2M")|(control1["genes"]=="TF")|(control1["genes"]=="SERPINA1")|(control1["genes"]=="APOA1")|(control1["genes"]=="HP")]["# PSMs"].tolist()
# list_control1=statistics.mean(list_control1)
#
# list_control2=control2[(control2["genes"]=="C3")|(control2["genes"]=="ALB")|(control2["genes"]=="APOB")|(control2["genes"]=="A2M")|(control2["genes"]=="TF")|(control2["genes"]=="SERPINA1")|(control2["genes"]=="APOA1")|(control2["genes"]=="HP")]["# PSMs"].tolist()
# list_control2=statistics.mean(list_control2)
#
# list_control3=control3[(control3["genes"]=="C3")|(control3["genes"]=="ALB")|(control3["genes"]=="APOB")|(control3["genes"]=="A2M")|(control3["genes"]=="TF")|(control3["genes"]=="SERPINA1")|(control3["genes"]=="APOA1")|(control3["genes"]=="HP")]["# PSMs"].tolist()
# list_control3=statistics.mean(list_control3)
#
# list_control4=control4[(control4["genes"]=="C3")|(control4["genes"]=="ALB")|(control4["genes"]=="APOB")|(control4["genes"]=="A2M")|(control4["genes"]=="TF")|(control4["genes"]=="SERPINA1")|(control4["genes"]=="APOA1")|(control4["genes"]=="HP")]["# PSMs"].tolist()
# list_control4=statistics.mean(list_control4)
#
#
# list_control5=control5[(control5["genes"]=="C3")|(control5["genes"]=="ALB")|(control5["genes"]=="APOB")|(control5["genes"]=="A2M")|(control5["genes"]=="TF")|(control5["genes"]=="SERPINA1")|(control5["genes"]=="APOA1")|(control5["genes"]=="HP")]["# PSMs"].tolist()
# list_control5=statistics.mean(list_control5)
#
# list_control6=control6[(control6["genes"]=="C3")|(control6["genes"]=="ALB")|(control6["genes"]=="APOB")|(control6["genes"]=="A2M")|(control6["genes"]=="TF")|(control6["genes"]=="SERPINA1")|(control6["genes"]=="APOA1")|(control6["genes"]=="HP")]["# PSMs"].tolist()
# list_control6=statistics.mean(list_control6)
#
# list_control7=control7[(control7["genes"]=="C3")|(control7["genes"]=="ALB")|(control7["genes"]=="APOB")|(control7["genes"]=="A2M")|(control7["genes"]=="TF")|(control7["genes"]=="SERPINA1")|(control7["genes"]=="APOA1")|(control7["genes"]=="HP")]["# PSMs"].tolist()
# list_control7=statistics.mean(list_control7)
#
# list_control8=control8[(control8["genes"]=="C3")|(control8["genes"]=="ALB")|(control8["genes"]=="APOB")|(control8["genes"]=="A2M")|(control8["genes"]=="TF")|(control8["genes"]=="SERPINA1")|(control8["genes"]=="APOA1")|(control8["genes"]=="HP")]["# PSMs"].tolist()
# list_control8=statistics.mean(list_control8)
#
# list_control9=control9[(control9["genes"]=="C3")|(control9["genes"]=="ALB")|(control9["genes"]=="APOB")|(control9["genes"]=="A2M")|(control9["genes"]=="TF")|(control9["genes"]=="SERPINA1")|(control9["genes"]=="APOA1")|(control9["genes"]=="HP")]["# PSMs"].tolist()
# list_control9=statistics.mean(list_control9)
#
# list_control10=control10[(control10["genes"]=="C3")|(control10["genes"]=="ALB")|(control10["genes"]=="APOB")|(control10["genes"]=="A2M")|(control10["genes"]=="TF")|(control10["genes"]=="SERPINA1")|(control10["genes"]=="APOA1")|(control10["genes"]=="HP")]["# PSMs"].tolist()
# list_control10=statistics.mean(list_control10)
#
# list_control11=control11[(control11["genes"]=="C3")|(control11["genes"]=="ALB")|(control11["genes"]=="APOB")|(control11["genes"]=="A2M")|(control11["genes"]=="TF")|(control11["genes"]=="SERPINA1")|(control11["genes"]=="APOA1")|(control11["genes"]=="HP")]["# PSMs"].tolist()
# list_control11=statistics.mean(list_control11)
#
# list_control12=control12[(control12["genes"]=="C3")|(control12["genes"]=="ALB")|(control12["genes"]=="APOB")|(control12["genes"]=="A2M")|(control12["genes"]=="TF")|(control12["genes"]=="SERPINA1")|(control12["genes"]=="APOA1")|(control12["genes"]=="HP")]["# PSMs"].tolist()
# list_control12=statistics.mean(list_control12)
#
# list_control13=control13[(control13["genes"]=="C3")|(control13["genes"]=="ALB")|(control13["genes"]=="APOB")|(control13["genes"]=="A2M")|(control13["genes"]=="TF")|(control13["genes"]=="SERPINA1")|(control13["genes"]=="APOA1")|(control13["genes"]=="HP")]["# PSMs"].tolist()
# list_control13=statistics.mean(list_control13)
#
# list_control14=control14[(control14["genes"]=="C3")|(control14["genes"]=="ALB")|(control14["genes"]=="APOB")|(control14["genes"]=="A2M")|(control14["genes"]=="TF")|(control14["genes"]=="SERPINA1")|(control14["genes"]=="APOA1")|(control14["genes"]=="HP")]["# PSMs"].tolist()
# list_control14=statistics.mean(list_control14)
#
# list_control15=control15[(control15["genes"]=="C3")|(control15["genes"]=="ALB")|(control15["genes"]=="APOB")|(control15["genes"]=="A2M")|(control15["genes"]=="TF")|(control15["genes"]=="SERPINA1")|(control15["genes"]=="APOA1")|(control15["genes"]=="HP")]["# PSMs"].tolist()
# list_control15=statistics.mean(list_control15)
#
# list_control16=control16[(control16["genes"]=="C3")|(control16["genes"]=="ALB")|(control16["genes"]=="APOB")|(control16["genes"]=="A2M")|(control16["genes"]=="TF")|(control16["genes"]=="SERPINA1")|(control16["genes"]=="APOA1")|(control16["genes"]=="HP")]["# PSMs"].tolist()
# list_control16=statistics.mean(list_control16)

# list_control2=control2[(control2["genes"]=="C3")|(control2["genes"]=="A2M")|(control2["genes"]=="C4B")|(control2["genes"]=="CP")|(control2["genes"]=="PLG")|(control2["genes"]=="GC")|(control2["genes"]=="CFB")|(control2["genes"]=="ITIH4")]["# PSMs"].tolist()
# list_control2=statistics.mean(list_control2)
#
#
# list_control3=control3[(control3["genes"]=="C3")|(control3["genes"]=="A2M")|(control3["genes"]=="C4B")|(control3["genes"]=="CP")|(control3["genes"]=="PLG")|(control3["genes"]=="GC")|(control3["genes"]=="CFB")|(control3["genes"]=="ITIH4")]["# PSMs"].tolist()
# list_control3=statistics.mean(list_control3)
#
#
# list_control4=control4[(control4["genes"]=="C3")|(control4["genes"]=="A2M")|(control4["genes"]=="C4B")|(control4["genes"]=="CP")|(control4["genes"]=="PLG")|(control4["genes"]=="GC")|(control4["genes"]=="CFB")|(control4["genes"]=="ITIH4")]["# PSMs"].tolist()
# list_control4=statistics.mean(list_control4)
#
#
# list_control5=control5[(control5["genes"]=="C3")|(control5["genes"]=="A2M")|(control5["genes"]=="C4B")|(control5["genes"]=="CP")|(control5["genes"]=="PLG")|(control5["genes"]=="GC")|(control5["genes"]=="CFB")|(control5["genes"]=="ITIH4")]["# PSMs"].tolist()
# list_control5=statistics.mean(list_control5)
#
#
# list_control6=control6[(control6["genes"]=="C3")|(control6["genes"]=="A2M")|(control6["genes"]=="C4B")|(control6["genes"]=="CP")|(control6["genes"]=="PLG")|(control6["genes"]=="GC")|(control6["genes"]=="CFB")|(control6["genes"]=="ITIH4")]["# PSMs"].tolist()
# list_control6=statistics.mean(list_control6)
#
#
# list_control6=control6[(control6["genes"]=="C3")|(control6["genes"]=="A2M")|(control6["genes"]=="C4B")|(control6["genes"]=="CP")|(control6["genes"]=="PLG")|(control6["genes"]=="GC")|(control6["genes"]=="CFB")|(control6["genes"]=="ITIH4")]["# PSMs"].tolist()
...
#
#
# list_control7=control7[(control7["genes"]=="C3")|(control7["genes"]=="A2M")|(control7["genes"]=="C4B")|(control7["genes"]=="CP")|(control7["genes"]=="PLG")|(control7["genes"]=="GC")|(control7["genes"]=="CFB")|(control7["genes"]=="ITIH4")]["# PSMs"].tolist()
# list_control7=statistics.mean(list_control7)
#
#
# list_control8=control8[(control8["genes"]=="C3")|(control8["genes"]=="A2M")|(control8["genes"]=="C4B")|(control8["genes"]=="CP")|(control8["genes"]=="PLG")|(control8["genes"]=="GC")|(control8["genes"]=="CFB")|(control8["genes"]=="ITIH4")]["# PSMs"].tolist()
# list_control8=statistics.mean(list_control8)
#
#
# list_control9=control9[(control9["genes"]=="C3")|(control9["genes"]=="A2M")|(control9["genes"]=="C4B")|(control9["genes"]=="CP")|(control9["genes"]=="PLG")|(control9["genes"]=="GC")|(control9["genes"]=="CFB")|(control9["genes"]=="ITIH4")]["# PSMs"].tolist()
# list_control9=statistics.mean(list_control9)
#
#
...
#
# # new_frame=new_frame[["Accession","genes1","H1","H2","H3","H4","H5","H6","H7","H8","H9"]]
# #
# #
# # # #
