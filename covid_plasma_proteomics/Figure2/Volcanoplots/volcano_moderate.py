...
# data_filter= z[["Accession","genes_2","genes_3","C1_1","C1_2","C2_1","C2_2","C2_3","C3_1","C3_2","C4_1","C4_2","C5_1","C5_2","C6_1",
...
# ax.annotate(list(first_10.keys())[34],(list(first_10.values())[34][0]-0.3,list(first_10.values())[34][1]+0.05),fontsize=12)
# ax.annotate(list(first_10.keys())[35],(list(first_10.values())[35][0]-0.32,list(first_10.values())[35][1]+0.05),fontsize=12)
# ax.annotate(list(first_10.keys())[36],(list(first_10.values())[36][0]-0.32,list(first_10.values())[36][1]-0.14),fontsize=12)
# ax.annotate(list(first_10.keys())[37],(list(first_10.values())[37][0]-0.32,list(first_10.values())[37][1]+0.05),fontsize=12)
#
# # #
# ax.annotate(list(first_10.keys())[38],(list(first_10.values())[38][0]-0.35,list(first_10.values())[38][1]-0.15),fontsize=12)
# ax.annotate(list(first_10.keys())[39],(list(first_10.values())[39][0]-0.6,list(first_10.values())[39][1]+0.07),fontsize=12)
# # #
# ax.annotate(list(first_10.keys())[40],(list(first_10.values())[40][0]-0.6,list(first_10.values())[40][1]+0.07),fontsize=12)
# ax.annotate(list(first_10.keys())[41],(list(first_10.values())[41][0]-0.2,list(first_10.values())[41][1]+0.05),fontsize=12)
# ax.annotate(list(first_10.keys())[42],(list(first_10.values())[42][0]-0.75,list(first_10.values())[42][1]+0.05),fontsize=12)
# ax.annotate(list(first_10.keys())[43],(list(first_10.values())[43][0]-0.45,list(first_10.values())[43][1]+0.05),fontsize=12)
# ax.annotate(list(first_10.keys())[44],(list(first_10.values())[44][0]-0.7,list(first_10.values())[44][1]+0.01),fontsize=12)
#
# # # ax.annotate(list(first_10.keys())[46],(list(first_10.values())[46][0]+0.1,list(first_10.values())[46][1]+0.05),fontsize=12)
# #
...
# # ax.annotate(list(first_10.keys())[60],(list(first_10.values())[60][0]+0.1,list(first_10.values())[60][1]),fontsize=12)
# # ax.annotate(list(first_10.keys())[61],(list(first_10.values())[61][0],list(first_10.values())[61][1]-0.05),fontsize=8)
#
# # ax.annotate(list(first_10.keys())[62],(list(first_10.values())[62][0]+0.15,list(first_10.values())[62][1]),fontsize=12)
# # ax.annotate(list(first_10.keys())[63],(list(first_10.values())[63][0]+0.15,list(first_10.values())[63][1]),fontsize=8)
# ax.annotate(list(first_10.keys())[64],(list(first_10.values())[64][0]-0.34,list(first_10.values())[64][1]+0.05),fontsize=12)
# # ax.annotate(list(first_10.keys())[65],(list(first_10.values())[65][0]+0.1,list(first_10.values())[65][1]+0.04),fontsize=12)
# # ax.annotate(list(first_10.keys())[66],(list(first_10.values())[66][0],list(first_10.values())[66][1]+0.1),fontsize=8)
# # ax.annotate(list(first_10.keys())[67],(list(first_10.values())[67][0]+0.05,list(first_10.values())[67][1]),fontsize=12)
# # ax.annotate(list(first_10.keys())[68],(list(first_10.values())[68][0]+0.05,list(first_10.values())[68][1]),fontsize=12)
#
# ax.annotate(list(first_10.keys())[69],(list(first_10.values())[69][0]+0.15,list(first_10.values())[69][1]+0.05),fontsize=12)
# # ax.annotate(list(first_10.keys())[70],(list(first_10.values())[70][0]+0.15,list(first_10.values())[70][1]),fontsize=12)
#
# # ax.annotate(list(first_10.keys())[71],(list(first_10.values())[71][0]+0.15,list(first_10.values())[71][1]),fontsize=12)
# # ax.annotate(list(first_10.keys())[72],(list(first_10.values())[72][0]+0.1,list(first_10.values())[72][1]),fontsize=12)
#
# # ax.annotate(list(first_10.keys())[73],(list(first_10.values())[73][0]+0.1,list(first_10.values())[73][1]),fontsize=12)
#
#
#
...
# ax.annotate(list(least7.keys())[1],(list(least7.values())[1][0]-0.85,list(least7.values())[1][1]-0.3),fontsize=12)
# ax.annotate(list(least7.keys())[2],(list(least7.values())[2][0]-0.65,list(least7.values())[2][1]+0.34),fontsize=12)
# ax.annotate(list(least7.keys())[3],(list(least7.values())[3][0]-0.75,list(least7.values())[3][1]+0.3),fontsize=12)
# ax.annotate(list(least7.keys())[4],(list(least7.values())[4][0]-0.25,list(least7.values())[4][1]+0.1),fontsize=12)
# ax.annotate(list(least7.keys())[5],(list(least7.values())[5][0]-0.3,list(least7.values())[5][1]-0.21),fontsize=12)
#
# ax.annotate(list(least7.keys())[6],(list(least7.values())[6][0]-0.5,list(least7.values())[6][1]+0.07),fontsize=12)
# ax.annotate(list(least7.keys())[7],(list(least7.values())[7][0]-0.2,list(least7.values())[7][1]+0.14),fontsize=12)
# ax.annotate(list(least7.keys())[8],(list(least7.values())[8][0]-0.35,list(least7.values())[8][1]-0.37),fontsize=12)
# ax.annotate(list(least7.keys())[9],(list(least7.values())[9][0]-0.5,list(least7.values())[9][1]+0.07),fontsize=12)
# ax.annotate(list(least7.keys())[10],(list(least7.values())[10][0]+0.19,list(least7.values())[10][1]+0.1),fontsize=12)
# ax.annotate(list(least7.keys())[11],(list(least7.values())[11][0]-0.7,list(least7.values())[11][1]+0.1),fontsize=12)
# ax.annotate(list(least7.keys())[12],(list(least7.values())[12][0]+0.1,list(least7.values())[12][1]-0.05),fontsize=12)
# ax.annotate(list(least7.keys())[13],(list(least7.values())[13][0]+0.1,list(least7.values())[13][1]+0.05),fontsize=12)
